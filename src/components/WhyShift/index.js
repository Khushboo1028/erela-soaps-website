...
import handmadeSoaps from '../../assets/handmade-soaps.jpeg';
			...
			<Fade>
				<Row>
					<Col md={6} style={{ padding: '0' }}>
						<img style={{ width: '100%', height: '500px' }} src={handmadeSoaps} alt="handmade soap" />
					</Col>
					<Col md={6}>
						<div style={{ width: '100%', padding: '0' }}>
							<h1 className={styles.h1Style}>Why Shift To Handmade Soaps?</h1>
